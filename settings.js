...
function bootApplication(app, config, passport) {
  var dbVal = { 
    ...
    , dbConn = mysql.createConnection(dbVal)
    , hostBaseUrl = (config.domain || 'http://localhost:' + port)
    , apiBaseUrl = process.env.SINGLY_API_HOST || 'https://api.singly.com'
    , singly = new Singly(config.singly.clientId, config.singly.clientSecret, config.singly.callbackURL);
  ...
  app.configure(function () {
    ...
    app.use(function (req, res, next) {
      ...
      res.locals.appName = 'ZEROBOUND'
      res.locals.appNameCase = 'Zero Bound'
      res.locals.title = 'You Are Not A Loan'
